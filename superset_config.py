...
# A new, strong secret key. You can generate one with `openssl rand -base64 42`
SECRET_KEY = get_env_variable('SUPERSET_SECRET_KEY', 'aVeryStrongAndSecureSecretKey12345!')
